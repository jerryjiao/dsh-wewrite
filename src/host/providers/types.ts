...
const RETRYABLE_BY_CODE: Readonly<Record<ImageErrorCode, boolean>> = {
  AUTH: false,
  RATE_LIMIT: true,
  TIMEOUT: true,
  NETWORK: true,
...
export class ImageProviderError extends Error {
  ...
  constructor(input: { providerId: string; code: ImageErrorCode; message: string; retryable?: boolean }) {
