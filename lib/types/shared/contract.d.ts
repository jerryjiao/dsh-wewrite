...
export declare const RPC_ENDPOINTS: readonly ["snapshot", "hotspots/fetch", "hotspots/digestItem", "article/list", "article/get", "article/save", "article/delete", "article/preview", "article/rewrite", "run/start", "run/cancel", "run/detail", "schedule/save", "schedule/delete", "schedule/toggle", "schedule/runNow", "config/get", "config/set", "credentials/set", "credentials/describe", "llm/options", "wechat/pushDraft", "wechat/diagnose"];
